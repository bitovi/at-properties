...
<div className="grid grid-cols-12 gap-4">
  <div className="col-span-2">
    <div className="bg-primary-100 text-primary-900 ar-2-3 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">2:3</div>
    </div>
  </div>
  <div className="col-span-3">
    <div className="bg-primary-100 text-primary-900 ar-3-2 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">3:2</div>
    </div>
  </div>
  <div className="col-span-3">
    <div className="bg-primary-100 text-primary-900 ar-3-4 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">3:4</div>
    </div>
  </div>
  <div className="col-span-4">
    <div className="bg-primary-100 text-primary-900 ar-4-3 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">4:3</div>
    </div>
  </div>
  <div className="col-span-2">
    <div className="bg-primary-100 text-primary-900 ar-4-5 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">4:5</div>
    </div>
  </div>
  <div className="col-span-4">
    <div className="bg-primary-100 text-primary-900 ar-5-4 border border-primary-500 relative">
      <div className="absolute top-0 w-full h-full pt-10 text-center text-3xl">5:4</div>
    </div>
  </div>
  <div className="col-span-6">
    <div className="bg-primary-100 text-primary-900 ar-16-9 border border-primary-500 relative">
...
* If the technologies being used can achieve the visual presentation, text is used to convey information rather than images of text except for the following: 1) Customizable: The image of text can be visually customized to the user's requirements; 2) Essential: A particular presentation of text is essential to the information being conveyed. [1.4.5 Images of Text (Level AA)](https://www.w3.org/WAI/WCAG21/quickref/#images-of-text)
* Images of text are only used for pure decoration or where a particular presentation of text is essential to the information being conveyed. [1.4.9 Images of Text (No Exceptions) (Level AAA)](https://www.w3.org/WAI/WCAG21/quickref/#images-of-text-no-exception)
* 

## Components

* [Figure](/?path=/story/pattern-library-components-figure--page)
* [Section Intro](/?path=/story/pattern-library-components-section--page)