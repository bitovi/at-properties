...
<Source language='html' code={dedent`
  ...
  <body>
    <div id="app">
      ...
      <div id="grids">
      <header className="dlp-nav">		
        <nav>
      <main id="main" className="dlp-main">
        <article id="agent">
        <article id="co-agent">
        <article id="team">
        <article id="company">
...
* [Navigation](/?path=/story/components-navigation--page)
* [Section Intro, Section Content](/?path=/story/components-section--page)
