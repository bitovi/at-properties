...
<table>
  ...
  <tbody>
    ...
    <tr>
      <th>Navigation</th>
      <td>Desktop: The red bar slides to each section as the user scrolls up and down the page. <br />
      Mobile: The menu icon animates between hamburger and x with smooth transitions. <br />
      The mobile menu slides up/down and menu items appear one by one.</td>
      <td>Desktop: The red bar instantly appears under each section as the user scrolls up and down the page. <br />
      Mobile: The menu icon switches between hamburger and x with no transition. <br />
      The mobile menu appears/disappears instantly with menu items already visible.</td>
    </tr>
    <tr>
      <th>Section Intro</th>
