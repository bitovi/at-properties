...
* **Spacing**: Testimonials are shown separated by a 1px light gray (Primary 100) horizontal rule, with 24px between the rule and each item.
...
<div>
  ...
  <div className="dlp-testimonial-wrapper w-2/3">
