import { Meta, Preview, Source, Story } from '@storybook/addon-docs/blocks';
...
* **Accessibility**: Notice that images use null `alt=""` and provide a text alternative via `aria-labelledby="[id of the figcaption]"`.
...
USES ITS OWN COMPONENT -- timeline
...
<div className="dlp-carousel">
  <div className="swiper-container dlp-carousel-items swiper-container-initialized swiper-container-horizontal">
    <div className="swiper-wrapper">
      <div className="swiper-slide swiper-slide-active mr-8">
        <figure className="dlp-display-card">
          <div className="dlp-display-card-content">
            <div className="">
              <img src="images/partners/ProperTitle-Logo_horiz_blue.png" />
            </div>
          </div>
        </figure>
      </div>
      <div className="swiper-slide swiper-slide-next mr-8">
        <figure className="dlp-display-card">
          <div className="dlp-display-card-content">
            <div className="">
              <img src="images/partners/proper-rate.jpeg" />
            </div>
          </div>
        </figure>
      </div>
      <div className="swiper-slide mr-8">
        <figure className="dlp-display-card">
          <div className="dlp-display-card-content">
            <div className="">
              <img src="images/partners/at-commercial-logo.png" />
            </div>
          </div>
        </figure>
      </div>
      <div className="swiper-slide mr-8">
        <figure className="dlp-display-card">
          <div className="dlp-display-card-content">
            <div className="">
              <img src="images/partners/chicago-asso-realtors.jpeg" />
            </div>
          </div>
        </figure>
      </div>
  ...
  <div id="dlp-carousel-nav-swiper65524" className="dlp-carousel-nav swiper-scrollbar">
