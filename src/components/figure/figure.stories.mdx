...
* Only the Agent photo will be `.pinned` (sticky).

<Preview>
<div className="w-1/2 dlp-figure__wrapper">
  ...
  <div className="dlp-figure__wrapper">
    <figure className="dlp-figure">
      <picture className="ar ar--4-3">
        <img src="images/selling/selling-2.jpg" alt="Cozy white living room with a large window" />
      </picture>
      <div className="dlp-figure__border"></div>
    </figure>
  </div>
...
<Source language='scss' code={dedent`
  ...
  .pinned {
    @apply sticky;             /* Sticky positioning is not supported in IE11. */
    top: theme('spacing.8');
  } 
  .hide {
