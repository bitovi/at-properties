...
* Images are coded as `figure`, with the exception of some logos (e.g., @properties, [partner](/?path=/docs/pattern-library-components-carousel--page#marketing-assets--partners) logos), which are SVGs.
* Most images have inner borders. The exceptions are [property](/?path=/docs/pattern-library-components-property--default-story) photos and images used in [carousels](/?path=/docs/pattern-library-components-carousel--page).
...
See [Property](/?path=/docs/pattern-library-components-property--default-story).

## Statistic photo

See [Statistic](/?path=/docs/pattern-library-components-statistic--page).
...
* See also: [Figure and figcaption – extended alternate text for screen readers?](https://www.hassellinclusion.com/blog/figure-figcaption-extended-alternate-text-screen-readers/), April 2019.