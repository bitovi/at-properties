        ...
        <div class="content-grid">
            ...
            <div class="col-span-4 md:col-span-7 lg:col-start-9 lg:col-span-7">
                <section id="agent-bio" class="">
                    ...
                    <h2 class="head-1 animate--fade">{{i18n.name}}</h2>
                    <h3 class="head-5 accent--above-left animate--fade">Agent Bio</h3>
                    <div v-html="i18n.bio.brief" class="animate--fade"></div>
                ...
                <section id="agent-testimonials" class="">
                    <h3 class="head-5 accent--above-left animate--fade">Testimonials</h3>
                    ...
                    <div class="btn-group">
                        <dlp-button type="button" class="animate--fade" @click="showModal('TestimonialsModal', $event)">View more testimonials</dlp-button>
                ...
                <section id="agent-sales" class="">
                    <h3 class="head-5 accent--above-left animate--fade">Recent Sales</h3>
                    ...
                    <div class="btn-group">
                        <dlp-button type="button" class="animate--fade" @click="showModal('SalesModal', $event)">View more sales</dlp-button>
                        <dlp-appear-modal ref="SalesModal">
                            <h3 class="head-5 accent--above-left mb-8 animate--fade">Recent Sales</h3>
                            <div class="dlp-property-wrapper">
                                <dlp-property
                                    class="animate--fade"
                ...
                <section id="agent-stats" class="">
                    <h3 class="head-5 accent--above-left animate--fade">Agent Stats</h3>
                ...
                <section id="agent-contact">
                    <h3 class="head-5 accent--above-left animate--fade">Agent Contact</h3>
                    <address class="contact-info animate--fade">
