        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-20 pb-40">
            ...
            <div>
                ...
                <section id="agent-stats" class="mb-16">
                    ...
                    <p class="mb-4">
                        <span class="head-3 block text-accent">Number One</span>
                        <span class="head-6">Top selling agent in Lincoln Park</span>
                    </p>
                    <p class="mb-4">
                        <span class="head-3 block text-accent">$20 Million</span>
                        <span class="head-6">Annual Sales in 2019</span>
                    </p>
                    <p class="mb-4">
                        <span class="head-3 block text-accent">30 Under 30</span>
